...
bool HybridRank::sgd_pair_step_by_choice(Model& model, const comparison& comp, const comparison& comp_user, double lambda, double step_size, int choice){
	switch(choice){
		case 0: return sgd_pair_step_0(model, comp, lambda, step_size); break;  //Only update V without updating U
		case 1: return sgd_pair_step_1(model, comp, lambda, step_size); break;  // update U and V regularly
