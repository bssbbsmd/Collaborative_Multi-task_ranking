...
void EvaluatorRating::load_files (const std::string& itemwise_test_file, const std::string& userwise_test_file, std::vector<int>& ik) {
  	...
  	std::cout << std::endl << "N_users:" << test.n_users << std::endl;
    std::cout << "N_items:"<< test.n_items << std::endl;
    std::cout <<" N_itemwise_test_ratings:" << test.n_itemwise_test_pairs <<std::endl;
  	std::cout << " N_userwise_test_ratings:" << test.n_userwise_test_pairs<<std::endl;
